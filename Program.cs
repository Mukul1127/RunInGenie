    ...
    internal static class Program
    {
        ...
        private static string Shell
        {
            get
            {
                ...
                if (shell == null || shell.Equals (value: string.Empty)) shell = "bash";
        ...
        private static void PrintHelp ()
        {
            ...
            Console.WriteLine (value: "RunInGenie - Copyright 2022 Mukul Kedia\n");
        ...
        private static int Main (string[] args)
        {
            ...
            string shell  = Program.Shell  == string.Empty ? "bash" : Program.Shell;
            ...
            try
            {
                string arguments = $"{distro} -e genie -c {shell}";
